...
# this is run with "sbatch finetune_xnli_tr.sh", from the academic-budget-bert directory.

#SBATCH --job-name=finetune_xnli_tr
#SBATCH --output=finetune_xnli_tr.out
#SBATCH --error=finetune_xnli_tr.err
